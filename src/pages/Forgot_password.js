  ...
  return (
    <div className='container'>
       <div className="card_header">
          <Link to={"/my"}><img src="https://www.fastwin.app/includes/icons/back_wt.png" alt="" /></Link>
          <p style={{ fontWeight: "bolder", fontSize: "18px" }}>Change Password</p>
          <p></p>
          </div>
        ...
        <div className="auth_form_submit">
          <button className="auth_submit_btn" style={{background:"#0093ff"}}>Change</button>
        </div>
